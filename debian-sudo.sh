...
#--- Now Install
PACKAGES="git tmux vim fzf ufw fail2ban wireguard bash-completion ripgrep build-essential jq htop zip unzip cmake tree postgresql-client python3-pip python3.13-venv rclone podman keepassxc-minimal"
