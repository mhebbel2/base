...
#--- Now Install
PACKAGES="git tmux vim fzf ufw fail2ban wireguard bash-completion ripgrep build-essential jq htop zip unzip cmake tree postgresql-client python3-pip rclone podman keepassxc-minimal"
